...
export type RawRoomGeometry = {
  ...
  ceilingArea:   number   // m²  (width × length)
  wallAreaFront: number   // m²  (length × height)
  wallAreaBack:  number   // m²  (length × height)
  wallAreaLeft:  number   // m²  (width × height)
  wallAreaRight: number   // m²  (width × height)
  aspectRatios: {
